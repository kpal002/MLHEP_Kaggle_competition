...
img_width, img_height, img_num_channels = 100, 100, 1
...
history = model.fit(train_data,real_data,epochs=epochs,shuffle = True,callbacks=[callback], validation_split=validation_split)
...
filename = "classification_kuntal_final.csv"
